...
use Common\Library\OpenTelemetry\API\Instrumentation\AutoInstrumentation\ConfigurationRegistry;
use Common\Library\OpenTelemetry\API\Instrumentation\AutoInstrumentation\Context as InstrumentationContext;
use Common\Library\OpenTelemetry\API\Instrumentation\AutoInstrumentation\GeneralInstrumentationConfiguration;
use Common\Library\OpenTelemetry\API\Instrumentation\AutoInstrumentation\HookManager;
use Common\Library\OpenTelemetry\API\Instrumentation\AutoInstrumentation\HookManagerInterface;
use Common\Library\OpenTelemetry\API\Instrumentation\AutoInstrumentation\Instrumentation;
use Common\Library\OpenTelemetry\API\Instrumentation\AutoInstrumentation\InstrumentationConfiguration;
use Common\Library\OpenTelemetry\API\Instrumentation\AutoInstrumentation\NoopHookManager;
use Common\Library\OpenTelemetry\API\Instrumentation\Configurator;
use Common\Library\OpenTelemetry\API\Logs\LateBindingLoggerProvider;
use Common\Library\OpenTelemetry\API\Logs\LoggerProviderInterface;
use Common\Library\OpenTelemetry\API\Metrics\LateBindingMeterProvider;
use Common\Library\OpenTelemetry\API\Metrics\MeterProviderInterface;
use Common\Library\OpenTelemetry\API\Trace\LateBindingTracerProvider;
...
use Common\Library\OpenTelemetry\SDK\Common\Configuration\EnvComponentLoaderRegistry;
use Common\Library\OpenTelemetry\SDK\Common\Configuration\EnvResolver;
...
use Common\Library\OpenTelemetry\SDK\Logs\EventLoggerProviderFactory;
use Common\Library\OpenTelemetry\SDK\Logs\LoggerProviderFactory;
use Common\Library\OpenTelemetry\SDK\Metrics\MeterProviderFactory;
use Common\Library\OpenTelemetry\SDK\Propagation\LateBindingTextMapPropagator;
use Common\Library\OpenTelemetry\SDK\Propagation\PropagatorFactory;
use Common\Library\OpenTelemetry\SDK\Resource\ResourceInfoFactory;
use Common\Library\OpenTelemetry\SDK\Trace\AutoRootSpan;
use Common\Library\OpenTelemetry\SDK\Trace\ExporterFactory;
use Common\Library\OpenTelemetry\SDK\Trace\SamplerFactory;
use Common\Library\OpenTelemetry\SDK\Trace\SpanProcessorFactory;

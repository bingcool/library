...
class ClientConfig extends BaseModel
{
    ...
    /**
     * Use Swoolefy CoroutinePools for Guzzle clients in Swoole coroutine context.
     */
    protected bool $useCoroutinePool = true;
    ...
    public function getUseCoroutinePool(): bool
    {
        return $this->useCoroutinePool;
    }

    public function setUseCoroutinePool(bool $useCoroutinePool): self
    {
        $this->useCoroutinePool = $useCoroutinePool;

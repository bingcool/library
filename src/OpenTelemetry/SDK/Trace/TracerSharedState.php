...
use Common\Library\OpenTelemetry\API\Trace as API; /** @phan-suppress-current-line PhanUnreferencedUseNormal */
...
use Common\Library\OpenTelemetry\SDK\Trace\SpanProcessor\MultiSpanProcessor;

...
use Swoolefy\Library\OpenTelemetry\API\Instrumentation\AutoInstrumentation\ConfigurationRegistry;
use Swoolefy\Library\OpenTelemetry\API\Instrumentation\AutoInstrumentation\Context as InstrumentationContext;
use Swoolefy\Library\OpenTelemetry\API\Instrumentation\AutoInstrumentation\GeneralInstrumentationConfiguration;
use Swoolefy\Library\OpenTelemetry\API\Instrumentation\AutoInstrumentation\HookManager;
use Swoolefy\Library\OpenTelemetry\API\Instrumentation\AutoInstrumentation\HookManagerInterface;
use Swoolefy\Library\OpenTelemetry\API\Instrumentation\AutoInstrumentation\Instrumentation;
use Swoolefy\Library\OpenTelemetry\API\Instrumentation\AutoInstrumentation\InstrumentationConfiguration;
use Swoolefy\Library\OpenTelemetry\API\Instrumentation\AutoInstrumentation\NoopHookManager;
use Swoolefy\Library\OpenTelemetry\API\Instrumentation\Configurator;
use Swoolefy\Library\OpenTelemetry\API\Logs\LateBindingLoggerProvider;
use Swoolefy\Library\OpenTelemetry\API\Logs\LoggerProviderInterface;
use Swoolefy\Library\OpenTelemetry\API\Metrics\LateBindingMeterProvider;
use Swoolefy\Library\OpenTelemetry\API\Metrics\MeterProviderInterface;
use Swoolefy\Library\OpenTelemetry\API\Trace\LateBindingTracerProvider;
...
use Swoolefy\Library\OpenTelemetry\SDK\Common\Configuration\EnvComponentLoaderRegistry;
use Swoolefy\Library\OpenTelemetry\SDK\Common\Configuration\EnvResolver;
...
use Swoolefy\Library\OpenTelemetry\SDK\Logs\EventLoggerProviderFactory;
use Swoolefy\Library\OpenTelemetry\SDK\Logs\LoggerProviderFactory;
use Swoolefy\Library\OpenTelemetry\SDK\Metrics\MeterProviderFactory;
use Swoolefy\Library\OpenTelemetry\SDK\Propagation\LateBindingTextMapPropagator;
use Swoolefy\Library\OpenTelemetry\SDK\Propagation\PropagatorFactory;
use Swoolefy\Library\OpenTelemetry\SDK\Resource\ResourceInfoFactory;
use Swoolefy\Library\OpenTelemetry\SDK\Trace\AutoRootSpan;
use Swoolefy\Library\OpenTelemetry\SDK\Trace\ExporterFactory;
use Swoolefy\Library\OpenTelemetry\SDK\Trace\SamplerFactory;
use Swoolefy\Library\OpenTelemetry\SDK\Trace\SpanProcessorFactory;
